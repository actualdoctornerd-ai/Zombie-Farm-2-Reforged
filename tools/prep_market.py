...
def main():
    ...
    for source_name, key, sprite, group, reward_only in [
        ...
        ("MerZombie", "ZombieActorMerZombie", "merzombie.png", "Large", False),
        ...
        ("Omega Dr. Zombie", "ZombieActorOmegaDrZombie", "omega_dr_zombie.png", "Garden", True),
        ("Omega Zombie Bot", "ZombieActorOmegaZombieBot", "omega_zombie_bot.png", "Headless", False),
        ("Poseidon Zombie", "ZombieActorPoseidon", "poseidon_zombie.png", "Large", False),
        ("Proto Zombie", "ZombieActorProto", "proto_zombie.png", "Small", True),
        ...
        ("Zombie Bot", "ZombieActorZombieBot", "zombie_bot.png", "Headless", False),
        ("Zombug", "ZombieActorZombug", "zombug.png", "Small", True),
        ...
        ("Dr. Zombie", "ZombieActorDrZombie", "dr_zombie.png", "Garden", True),
