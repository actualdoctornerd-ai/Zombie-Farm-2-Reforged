...
- **Epic Bosses (eight recovered bosses):** Market â†’ Epic Boss offers Dr. Groundhog, Loco Locust, Bully Frog, Foul Owl, Skunkarella, Rocky Rhino, General Larvaelus, and Mystical Mamba as repeatable 14-day runs for 10 brains. All use 30-second manual-focus fights, permanent casualties, retained damage, retry/reset timers, namespaced rewards, pets, and deterministic online replay. The first five use exact authored combat strips; EPB 8-10 use static recovered art until their missing atlas metadata can be reconstructed. See `docs/EPIC_BOSS_MECHANICS.md`.
