...
export function buildEnemyUnits(
  ...
  // A resolved stage (resolveStageWave) always carries `enemyKeys`; the fallback keeps
  // an unresolved weighted stage buildable in the grouped order it always had.
  const keys =
