...
> on the recipient (a special zombie needs three levels under the one its own invasion / Epic Boss
> event / the Zombie Pot opens at, over a floor of 20 — see `../docs/SPECIAL_ZOMBIE_ACQUISITION.md`;
